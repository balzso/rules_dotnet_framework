load("@rules_dotnet_framework//dotnet/private/deps:nuget.bzl", "dotnet_repositories_nuget")
load("@rules_dotnet_framework//dotnet/private/deps:nuget2.bzl", "dotnet_repositories_nuget2")
...
def dotnet_repositories_nugets():
    ...
    http_archive(
        name = "vstest",
        build_file = "@rules_dotnet_framework//3rd_party/vstest:repo.bzl",
