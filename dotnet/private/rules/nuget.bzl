...
def _dotnet_nuget_impl(
    ...
    if build_file_content:
        ...
        ctx.template(
            build_file_name,
            Label("@rules_dotnet_framework//dotnet/private:BUILD.nuget.bazel"),
            executable = False,
        )
...
load("@rules_dotnet_framework//dotnet:defs.bzl", "dotnet_import_library", "core_import_library", "net_import_library", "core_import_binary", "net_import_binary", "core_libraryset", "net_libraryset", "dotnet_libraryset")
"""
