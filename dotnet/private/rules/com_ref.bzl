...
net_com_library = rule(
    ...
    attrs = {
        ...
        "_tlbimp_wrapper": attr.label_keyed_string_dict(
            default = {Label("@rules_dotnet_framework//dotnet/tools/tlbimp_wrapper:tlbimp_wrapper_{}.exe".format(framework)): framework for framework in DOTNET_NET_FRAMEWORKS},
        ),
    },
