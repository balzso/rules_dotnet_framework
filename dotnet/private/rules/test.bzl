...
load(
    "@rules_dotnet_framework//dotnet/private/rules:runfiles.bzl",
    "CopyRunfiles",
)
load(
    "@rules_dotnet_framework//dotnet/private/rules:data_with_dirs.bzl",
    "CopyDataWithDirs",
)
...
dotnet_nunit_test = rule(
    ...
    attrs = {
        ...
        "_xslt": attr.label(default = Label("@rules_dotnet_framework//tools/converttests:n3.xslt"), allow_files = True),
