...
core_library(
    ...
    keyfile = "@rules_dotnet_framework//3rd_party/vstest:vstest.snk",
    visibility = ["//visibility:public"],
    deps = [
        "@rules_dotnet_framework//dotnet/stdlib.core:libraryset",
    ],
)
...
core_library(
    ...
    srcs = glob(
        ...
        exclude = ["**/Friends.cs"],
    ) + ["@rules_dotnet_framework//3rd_party/vstest:ObjectModel_Friends.cs"],
    defines = [
        "TRACE",
        "NETSTANDARD2_0",
    ],
...
core_library(
    ...
    srcs = glob(
        ...
        exclude = ["**/Friends.cs"],
    ) + ["@rules_dotnet_framework//3rd_party/vstest:Common_Friends.cs"],
    defines = [
        "TRACE",
        "NETSTANDARD2_0",
    ],
...
core_library(
    ...
    srcs = glob(
        ...
        exclude = ["**/Friends.cs"],
    ) + ["@rules_dotnet_framework//3rd_party/vstest:CommunicationUtilities_Friends.cs"],
    defines = [
        "TRACE",
        "NETSTANDARD2_0",
    ],
